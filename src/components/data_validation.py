...
class DataValidation:
    ...
    def validate_number_of_columns(self, dataframe: DataFrame) -> bool:
        """
        Method Name: validate_nummber_of_columns
        Description: This method validates the no. of columns
    ...
    def is_column_exist(self, df: DataFrame) -> bool:
        ...
        Description: This method validates the existence of numerical and catrgorical columns
